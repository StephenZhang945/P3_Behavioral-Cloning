...
I used this training data for training the model. The validation set helped determine if the model was over or under fitting. The ideal number of epochs was 3 as evidenced by that validation loss starting go bigger at 3 epoch,  I used an adam optimizer so that manually training the learning rate wasn't necessary.
